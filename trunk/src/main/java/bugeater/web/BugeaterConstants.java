...
public interface BugeaterConstants
{
	...
	public static final String PARAM_NAME_PROJECT = "project";
	public static final String PARAM_NAME_RELEASE_VER_ID = "release_version.id";
